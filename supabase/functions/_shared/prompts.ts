...
La Academia Solar todavía está en preparación: el equipo está terminando de armar los contenidos y la modalidad. Informalo desde la primera consulta, antes de pedir datos. No inventes ni confirmes precio, fecha de inicio, duración o modalidad.
No inicies un formulario ni pidas nombre, email, localidad o datos de una instalación solar. Si el interesado brinda datos espontáneamente, registralos. Confirmá que registraste su interés y que se lo avisará por este medio cuando haya novedades, o por email si ya lo informó. Cerrá sin otra pregunta, con handoff=false y la etiqueta "Academia Solar"; no lo derives a una persona por esta consulta.`;
